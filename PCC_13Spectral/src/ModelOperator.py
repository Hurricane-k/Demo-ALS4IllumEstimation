try:
    ...
    from PCC_13Spectral.config.settings import DEVICE
    from PCC_13Spectral.src.ModelBase import ModelBase
    from PCC_13Spectral.src.PCC import JosaPcc


class ModelOperator(ModelBase):
    """ Abstract of predict and optimize of DNN model, which inherited from ModelBase"""
    def __init__(self,in_feature=8, neurons=8):
        super().__init__()
        self._network = JosaPcc(in_feature=in_feature, 
